...
{
    public class DeleteAliasRequest : RequestBase, IRequestBase
    {
        public string ServiceName { get; set; }
        public string AliasName { get; set; }
        public Dictionary<string, string> Headers { get; set; }

        public DeleteAliasRequest(string serviceName, string aliasName,  Dictionary<string, string> customHeaders = null)
        {
