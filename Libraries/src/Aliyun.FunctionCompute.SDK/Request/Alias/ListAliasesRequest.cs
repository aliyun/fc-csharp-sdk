...
{
    public class ListAliasesRequest : RequestBase, IRequestBase
    {
        ...
        public ListAliasesRequest(string serviceName, int limit = 0, string prefix = null, string startKey = null, string nextToken = null, Dictionary<string, string> customHeaders = null)
        { 
