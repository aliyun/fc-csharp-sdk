...
{
    public class ListCustomDomainsRequest : RequestBase, IRequestBase
    {
        ...
        public ListCustomDomainsRequest(int limit = 0, string prefix = null, string startKey = null, string nextToken = null, Dictionary<string, string> customHeaders = null)
        {
            this.Limit = limit;
            this.Prefix = prefix;
