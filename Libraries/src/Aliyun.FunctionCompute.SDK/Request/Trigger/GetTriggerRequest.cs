...
{
    public class GetTriggerRequest : RequestBase, IRequestBase
    {
        ...
        public GetTriggerRequest(string serviceName, string functionName, string triggerName, Dictionary<string, string> customHeaders = null)
        {
